...
const listPage = (option) => {
    ...
    var appLang = app.globalData.lang;
    console.log(appLangData,appLang)
    ...
    let opt_default = {
        ...
        isReach: false,             //是否合并
        moreTxt: appLangData.public.moreText[appLang],
        noMoreTxt: appLangData.public.noMoreText[appLang],
        data: {},
        dataType: 'json',
